        ...
        <div style={{ display: 'flex', flexDirection: 'column' }}>
          {result ? (
             <>
               <div className="card" style={{ padding: 'var(--space-lg)', textAlign: 'center', borderColor: getResultColor(result.classificationRaw) }}>
                  ...
                  <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr 1fr', gap: 'var(--space-sm)', marginTop: 'var(--space-xl)' }}>
                    <div>
                      <Typography variant="h3" style={{ display: 'flex', alignItems: 'baseline', justifyContent: 'center', gap: '4px' }}>
                        {result.imcObs.toFixed(2)} <span style={{ fontSize: '0.6em', fontWeight: 'normal', color: 'var(--color-text-secondary)' }}>Kg/m<sup>2</sup></span>
                      </Typography>
                      <Typography variant="caption">{t('lbl_bmi_obs')}</Typography>
                    </div>
                    <div>
                      <Typography variant="h3" style={{ display: 'flex', alignItems: 'baseline', justifyContent: 'center', gap: '4px' }}>
                        {result.imcEst.toFixed(2)} <span style={{ fontSize: '0.6em', fontWeight: 'normal', color: 'var(--color-text-secondary)' }}>Kg/m<sup>2</sup></span>
                      </Typography>
            ...
            <div className="card" style={{ padding: 'var(--space-3xl)', textAlign: 'center', opacity: 0.5, display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
               <Typography variant="body1">{t('empty_bmi')}</Typography>
            </div>
          )}
        </div>
      </div>
